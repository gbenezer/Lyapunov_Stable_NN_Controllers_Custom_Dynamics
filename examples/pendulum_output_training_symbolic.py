...
def main(cfg: DictConfig):
    ...
    if cfg.train.train_lyaloss:
        ...
        for n, scale in enumerate(cfg.model.limit_scale):
            limit = limit_xe * scale
            lower_limit = -limit
            upper_limit = limit
            ...
            save_name = f"lyaloss_{kappa}kappa_{scale}_{u_max}.pth"
            if save_lyaloss:
    ...
    lrv.plot_lyapunov_2d(
        ...
        rho=rho,
        title="Lyapunov Function for Symbolic Inverted Pendulum System, Output Feedback",
